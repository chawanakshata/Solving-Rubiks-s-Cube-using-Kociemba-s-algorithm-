...
def main():
    ...
    while True:
        ...
        while True:
            ...
            print("-----------------------------------------------------------------------------")
            print("Notations of cube:")
            print("F - Move front face clockwise,                     F' - Move front face counterclockwise")
            print("F2 - Move front face 180 degrees(twice) clockwise, F2' - Move front face 180 degrees(twice) counterclockwise")
            print("R - Move right face clockwise,                     R' - Move right face counterclockwise")
            print("R2 - Move right face 180 degrees(twice) clockwise, R2' - Move right face 180 degrees(twice) counterclockwise")
            print("L - Move left face clockwise,                     L' - Move left face counterclockwise")
            print("L2 - Move left face 180 degrees(twice) clockwise, B2' - Move left face 180 degrees(twice) counterclockwise")
            print("B - Move back face clockwise,                     L' - Move back face counterclockwise")
            print("B2 - Move back face 180 degrees(twice) clockwise, B2' - Move back face 180 degrees(twice) counterclockwise")
            print("U - Move upper face clockwise,                     U' - Move upper face counterclockwise")
            print("U2 - Move upper face 180 degrees(twice) clockwise, U2' - Move upper face 180 degrees(twice) counterclockwise")
            print("D - Move down face clockwise,                     D' - Move down face counterclockwise")
            print("D2 - Move down face 180 degrees(twice) clockwise, D2' - Move down face 180 degrees(twice) counterclockwise")            
            print("------------------------------------------------------------------------------")
